(defun color-theme-arjen2 ()
  "Modified arjen color theme. Original ajren color themee by awiersma, created 2001-08-27."
  (interactive)
  (color-theme-install
   '(color-theme-arjen
     ...
     (border-glyph ((t (nil))))
     (buffers-tab ((t (:background "black" :foreground "gray"))))
     ...
     (custom-changed-face ((t (:background "blue" :foreground "gray"))))
     ...
     (custom-modified-face ((t (:background "blue" :foreground "gray"))))
     (custom-rogue-face ((t (:background "black" :foreground "pink"))))
     (custom-saved-face ((t (:underline t))))
     (custom-set-face ((t (:background "gray" :foreground "blue"))))
     ...
     (eshell-ls-symlink-face ((t (:foreground "Gray"))))
     ...
     (italic ((t (nil))))
     (left-margin ((t (nil))))
     (list-mode-item-selected ((t (:background "gray68" :foreground "gray"))))
     ...
     (modeline ((t (:background "DarkRed" :foreground "gray" :box (:line-width 1 :style released-button)))))
     (modeline-buffer-id ((t (:background "DarkRed" :foreground "gray"))))
     (modeline-mousable ((t (:background "DarkRed" :foreground "gray"))))
     (modeline-mousable-minor-mode ((t (:background "DarkRed" :foreground "gray"))))
     ...
     (show-paren-mismatch-face ((t (:background "Red" :foreground "Gray"))))
